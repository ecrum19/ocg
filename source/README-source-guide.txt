...
2. Run `npm install --save-dev ontology-companion-generator`, then initialize the project with `npx ocg init --ontology path/to/ontology.ttl`. The command creates the config, schema, workflow, and OCG npm scripts.
